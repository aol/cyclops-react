 ...
 */
   ...
   */
    ...
    */
    ...
    /**
     * Right unfold a function into a ReactiveSeq
     *
     * <pre>
     * {@code
     *  ReactiveSeq.unfold(1,i->i<=6 ? Optional.of(Tuple.tuple(i,i+1)) : Optional.empty());
    ...
    static <U, T> ReactiveSeq<T> unfoldRight(final U seed, final Function<? super U, Optional<Tuple2<U, T>>> unfolder) {
        return ReactiveSeq.fromSpliterator(new UnfoldRightSpliterator<>(seed, unfolder));
    }
        ...
        public static Unfoldable<reactiveSeq> unfoldable(){
            return new Unfoldable<reactiveSeq>() {
                ...
                public <R, T> Higher<reactiveSeq, R> unfoldRight(T b, Function<? super T, Optional<Tuple2<T, R>>> fn) {
                    return ReactiveSeq.unfoldRight(b,fn);
                }
            };
        }
        /**
